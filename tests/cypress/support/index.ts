declare namespace Cypress {
    interface Chainable {
        ...
        APIWithoutToken(APImethod: "GET" | "POST" | "DELETE" | "PUT", endpoint: string, APIstatus: number):void
        APIInvalidtToken(APImethod: "GET" | "POST" | "DELETE" | "PUT", endpoint: string, APIstatus: number):void
        APIRequest(APImethod: "GET" | "POST" | "DELETE" | "PUT", endpoint: string,APIbody:any, APIstatus: number):void
    }
}