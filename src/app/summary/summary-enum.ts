export enum summary{
    ...
    summaryImage = 'summary-item-image-',
    summaryTitle = 'summary-item-title-',
    summaryPrice = 'summary-item-price-',
    summaryCount = 'summary-item-count-',
    summaryAmount = 'summary-item-amount-',
    summaryPriceWithAccesories = 'summary-single-item-total-price-',
    summaryWarrantyDiv = 'summary-warranty-div-',
    summaryWarrantyTitle = 'summary-warranty-title-',
    summaryWarrantyPrice = 'summary-warranty-price-',
    summaryReturnOptionDiv = 'summary-return-option-div-',
    summaryReturnOptionTitle = 'summary-return-option-title-',
    summaryReturnOptionPrice = 'summary-return-option-price-',

    summaryTotalPriceDiv = 'summary-total-price-div',
    summaryTotalPriceTitle = 'summary-total-price-title',
    summaryTotalPricePrice = 'summary-total-price-price',


    backToAddress = 'summary-back-to-address',
    order = 'summary-order'
}